...
void send() {
	// 윈도우 찾기
	HWND m_Window = ::FindWindow(NULL, TEXT("Bounce1"));    // "Rx Window"는 수신측 윈도우의 이름
	...
	::SendMessage(m_Window, WM_COPYDATA, 0, (LPARAM)&copyData);
	//::SendMessage(m_Window, WM_USER + 1, 0, 0);
}
